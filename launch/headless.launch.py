...
Identical timing and gait strategy to spawn_pady.launch.py but:
...
Usage
-----
ros2 launch pady_robot headless.launch.py kick_torque:=4.0 kick_torque_right:=-4.0 body_force:=8.0 spawn_pitch:=0.45 spawn_roll:=-0.20
"""
